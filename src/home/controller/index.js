...
export default class extends Base {
    ...
    async moreAction(){
        ...
        let pagesize=this.get("pagesize")||10;
        //分页
        // let itemList=await this.model("home").getPageSelect({ispublished:1,item:{"==":1 }},pagenumber,pagesize);
        // let result = await this.model("home").getPageCountSelect({ispublished:1,item:{"==":1}},pagenumber,pagesize);

        let itemList=await this.model("home").getPageSelect({ispublished:1,item: {'!=': 2}, },pagenumber,pagesize);
        let result = await this.model("home").getPageCountSelect({ispublished:1,item: {'!=': 2},},pagenumber,pagesize);
    ...
    async sitemapAction() {
        ...
        let others=[
            ...
            { id: 2, itemname: '资讯',url:'news.html' },
